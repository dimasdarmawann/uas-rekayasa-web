...
<div class="card">
    ...
    <div class="p-4">
        <form action="<?php echo e(route('kegiatan.store')); ?>" method="POST" enctype="multipart/form-data" id="formKegiatan">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\crud_uas_241011750222\resources\views/kegiatan/create.blade.php ENDPATH**/ ?>