...
<?php $__env->startSection('header','Data Kegiatan Ekstrakurikuler'); ?>
    ...
    <div class="col-md-4">
        <div class="card p-4 h-100">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <div style="font-size:26px;font-weight:800;color:#0f172a;"><?php echo e($kegiatans->count()); ?></div>
    ...
    <div class="col-md-4">
        <div class="card p-4 h-100">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <div style="font-size:26px;font-weight:800;color:#0f172a;"><?php echo e($kegiatans->pluck('hari')->unique()->count()); ?></div>
    ...
    <div class="col-md-4">
        <div class="card p-4 h-100">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <div style="font-size:26px;font-weight:800;color:#0f172a;"><?php echo e($kegiatans->pluck('pembina')->unique()->count()); ?></div>
...
<div class="card">
    <div class="card-header-custom">
        ...
        <div class="d-flex gap-2 flex-wrap align-items-center">
            ...
            <a href="<?php echo e(route('kegiatan.create')); ?>" class="btn btn-primary btn-sm"><i class="fas fa-plus me-1"></i>Tambah</a>
            <a href="<?php echo e(route('kegiatan.pdf')); ?>" class="btn btn-danger btn-sm"><i class="fas fa-file-pdf me-1"></i>PDF</a>
        </div>
    </div>
    <div class="p-4">
            ...
            <table id="tbl" class="table table-hover align-middle w-100">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="font-weight:600;color:#1e293b;"><?php echo e($k->nama_kegiatan); ?></td>
                        <td>
                            <?php $hariColor=['Senin'=>'#6366f1','Selasa'=>'#8b5cf6','Rabu'=>'#10b981','Kamis'=>'#f59e0b','Jumat'=>'#ef4444','Sabtu'=>'#3b82f6']; $c=$hariColor[$k->hari]??'#64748b'; ?>
                            <span style="background:<?php echo e($c); ?>14;color:<?php echo e($c); ?>;padding:5px 14px;border-radius:20px;font-size:12px;font-weight:600;display:inline-flex;align-items:center;gap:5px;">
                                <span style="width:6px;height:6px;border-radius:50%;background:<?php echo e($c); ?>;display:inline-block;"></span>
                                <?php echo e($k->hari); ?>

                            </span>
                        </td>
                        <td><i class="fas fa-clock me-1" style="color:#94a3b8;font-size:11px;"></i><?php echo e(\Carbon\Carbon::parse($k->waktu)->format('H:i')); ?> WIB</td>
                        <td>
                            <div class="d-flex align-items-center gap-2">
                                <div style="width:30px;height:30px;background:linear-gradient(135deg,#6366f1,#a855f7);border-radius:9px;display:flex;align-items:center;justify-content:center;color:white;font-size:11px;font-weight:700;flex-shrink:0;"><?php echo e(strtoupper(substr($k->pembina,0,1))); ?></div>
                                <span style="font-size:13.5px;"><?php echo e($k->pembina); ?></span>
                            </div>
                        </td>
                        <td><i class="fas fa-clock me-1" style="color:#94a3b8;font-size:11px;"></i><?php echo e(\Carbon\Carbon::parse($k->updated_at)->diffForHumans()); ?></td>
                        <td>
                            <div class="d-flex gap-1">
                                <a href="<?php echo e(route('kegiatan.edit',$k->id_kegiatan)); ?>" class="btn btn-warning btn-sm px-3 py-1"><i class="fas fa-edit me-1"></i>Edit</a>
                                <form action="<?php echo e(route('kegiatan.destroy',$k->id_kegiatan)); ?>" method="POST" class="form-delete">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\crud_uas_241011750222\resources\views/kegiatan/index.blade.php ENDPATH**/ ?>