...
<div class="right-panel">
    ...
    <div class="login-form">
        ...
        <?php if(session('error')): ?>
            <div class="alert-err"><i class="fas fa-exclamation-circle"></i><?php echo e(session('error')); ?></div>
        <?php endif; ?>
        <?php if(session('success')): ?>
            <div class="alert-succ"><i class="fas fa-check-circle"></i><?php echo e(session('success')); ?></div>
        <?php endif; ?>
        <form action="<?php echo e(route('login.post')); ?>" method="POST">
            ...
            <div class="input-group-custom">
                ...
                <div class="input-wrap">
                    ...
                    <input id="username" type="text" name="username" placeholder="Masukkan username" value="<?php echo e(old('username')); ?>" class="<?php $__errorArgs = ['username'];
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="err"><i class="fas fa-times-circle"></i><?php echo e($message); ?></div><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                </div>
            ...
            <div class="input-group-custom">
                ...
                <div class="input-wrap">
                    ...
                    <input id="password" type="password" name="password" placeholder="Masukkan password" class="<?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="back-link">
            <a href="<?php echo e(route('home')); ?>"><i class="fas fa-arrow-left"></i>Kembali ke halaman publik</a>
        </div>
    </div>
</div>
<script>
...
<?php /**PATH C:\laragon\www\crud_uas_241011750222\resources\views/auth/login.blade.php ENDPATH**/ ?>