...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> — Ekskul Manager</title>
...
<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-nav">
        ...
        <a href="<?php echo e(route('kegiatan.index')); ?>" class="nav-link <?php echo e(request()->routeIs('kegiatan.index') ? 'active' : ''); ?>">
            <i class="fas fa-calendar-check"></i> Data Kegiatan
        </a>
        <a href="<?php echo e(route('kegiatan.create')); ?>" class="nav-link <?php echo e(request()->routeIs('kegiatan.create') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('kegiatan.pdf')); ?>" class="nav-link">
    ...
    <div class="sidebar-footer">
        <div class="user-card">
            ...
            <div class="user-info">
                <div class="name"><?php echo e(session('username','Admin')); ?></div>
...
<div class="main-content" id="mainContent">
    <div class="topbar">
        <div class="topbar-left">
            ...
            <h5><?php echo $__env->yieldContent('header','Dashboard'); ?></h5>
        </div>
...
<script>
    <?php if(session('success')): ?>
        Swal.fire({toast:true, position:'top-end', icon:'success', title:<?php echo json_encode(session('success'), 15, 512) ?>, showConfirmButton:false, timer:2800, timerProgressBar:true});
    <?php endif; ?>
    <?php if(session('error')): ?>
        Swal.fire({toast:true, position:'top-end', icon:'error', title:<?php echo json_encode(session('error'), 15, 512) ?>, showConfirmButton:false, timer:3200, timerProgressBar:true});
    <?php endif; ?>
</script>
<script>
...
<?php /**PATH C:\laragon\www\crud_uas_241011750222\resources\views/layouts/app.blade.php ENDPATH**/ ?>